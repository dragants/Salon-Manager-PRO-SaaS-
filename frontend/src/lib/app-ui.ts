...
export const appTableHeadClass =
  "border-b border-border bg-gradient-to-b from-muted to-muted/70 text-left text-xs font-semibold uppercase tracking-wide text-muted-foreground";

export const appTableRowClass =
  "h-12 border-b border-border transition-colors hover:bg-white/[0.03]";
