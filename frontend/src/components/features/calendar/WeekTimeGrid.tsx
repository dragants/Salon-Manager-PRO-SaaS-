      ...
      <div className="flex min-w-[760px] touch-pan-x touch-pan-y">
        <div className="sticky left-0 z-20 w-11 shrink-0 border-r border-border bg-muted/60">
          ...
          {hours.map((h) => (
            <div
              key={h}
              className="box-border border-b border-border pr-1 pt-0.5 text-right text-[10px] tabular-nums text-muted-foreground"
        ...
        {detailRow ? (
          <>
            ...
            <dl className="space-y-2 text-sm text-foreground">
              <div>
                <dt className="text-xs text-muted-foreground">Usluga</dt>
              ...
              {appointmentStaffLabel(detailRow) ? (
                <div>
                  <dt className="text-xs text-muted-foreground">Radnik</dt>
    ...
    <DragCalendar onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
      ...
      <DragOverlay dropAnimation={null}>
        {activeDrag ? (
          ...
          >
            <p className="text-[10px] font-semibold tabular-nums opacity-95">
              {overlayTime}
            </p>
            <p className="truncate text-[11px] font-medium opacity-95">
