...
## 1. Razbijanje finances/page.tsx (1191 → ~374 linije u `page.tsx`)
...
| **page.tsx (novi)** | **374** | Data fetching + kompozicija |

**Ukupno:** ~1133 linija u 7 fajlova (svaka komponenta ispod ~210 linija; `page.tsx` ispod 400).
...
**Svi testovi prolaze:** `npm test` u `backend/` — **127** pass / 0 fail (10 test fajlova, uključujući `hash.test.js`).
...
| Metrika | Pre | Posle |
|---------|-----|-------|
| finances/page.tsx | 1191 linija | ~374 linije u `page.tsx` (~−69%) |
| Backend test fajlova | 6 | 10 (+4) |
| Backend test cases | 47 | 127 (+80 novih u rundi 3) |
